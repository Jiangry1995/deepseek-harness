...
flowchart LR
  ...
  plugin_acp_memory["memory<br/>@deepseek-ai/dsh-memory"]
  cfg --> plugin_acp_memory
  plugin_acp_tool_memory["tool-memory<br/>@deepseek-ai/dsh-tool-memory"]
  cfg --> plugin_acp_tool_memory
