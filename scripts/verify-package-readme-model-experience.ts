...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/browser-extension': { kind: 'none', reason: 'The browser-side provider transports already-defined browser operations and registers nothing model-facing.' },
  ...
  'packages/client/ui-web': { kind: 'indirect', reason: 'The browser control routes the /web command; dsh-web-networking owns the resulting tool visibility.' },
  ...
  'packages/client/ui-settings-vision-fallback': { kind: 'none', reason: 'Browser-side settings editor and model-catalog projection; registers nothing model-facing.' },
  ...
  'packages/bundle/vision-fallback': { kind: 'indirect', reason: 'The static bundle delegates conditional model-visible behavior to dsh-llm-vision-fallback.' },
  ...
  'packages/memory/memory': { kind: 'indirect', reason: 'The file store delegates model rendering to dsh-tool-memory.' },
  ...
  'packages/web/browser': { kind: 'indirect', reason: 'The service delegates model rendering to dsh-tool-browser.' },
