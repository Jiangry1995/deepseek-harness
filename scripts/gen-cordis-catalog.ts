...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  LlmImageFallback: 'llm-streaming.md',
  ImageInputResolution: 'llm-streaming.md',
  ...
  MemoryFileEntry: 'memory.md',
  MemoryHandbook: 'memory.md',
  MemoryNoteWrite: 'memory.md',
  MemoryScope: 'memory.md',
  MemorySearchHit: 'memory.md',
  MemorySkillFile: 'memory.md',
  MemoryStore: 'memory.md',
  ...
  BrowserClientLease: 'browser.md',
  BrowserClientId: 'browser.md',
  BrowserCommand: 'browser.md',
  BrowserCompletion: 'browser.md',
  BrowserCompletionReceipt: 'browser.md',
  BrowserDisconnectReceipt: 'browser.md',
  BrowserDocumentId: 'browser.md',
  BrowserOpenTabRequest: 'browser.md',
  BrowserOpenTabSpec: 'browser.md',
  BrowserOperation: 'browser.md',
  BrowserOperationResult: 'browser.md',
  BrowserFillPageRequest: 'browser.md',
  BrowserInspectPageRequest: 'browser.md',
  BrowserInspectPageSpec: 'browser.md',
  BrowserPage: 'browser.md',
  BrowserPageAction: 'browser.md',
  BrowserPageActionReceipt: 'browser.md',
  BrowserPageElementRef: 'browser.md',
  BrowserPageField: 'browser.md',
  BrowserPageId: 'browser.md',
  BrowserPageInspect: 'browser.md',
  BrowserPageTarget: 'browser.md',
  BrowserPressKey: 'browser.md',
  BrowserPressModifiers: 'browser.md',
  BrowserPressPageRequest: 'browser.md',
  BrowserPressPageSpec: 'browser.md',
  BrowserReadPageRequest: 'browser.md',
  BrowserRequestId: 'browser.md',
  BrowserScrollMovement: 'browser.md',
  BrowserScrollPageRequest: 'browser.md',
  BrowserScrollReceipt: 'browser.md',
  BrowserSelectPageRequest: 'browser.md',
  BrowserTab: 'browser.md',
  BrowserWaitCondition: 'browser.md',
  BrowserWaitPageRequest: 'browser.md',
  BrowserWaitPageSpec: 'browser.md',
