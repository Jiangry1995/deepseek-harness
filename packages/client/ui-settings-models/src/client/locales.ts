...
export const en = {
  ...
  modelImageInputHint: 'Only enable models that actually accept pictures. Automatic vision can use these as helpers.',
  addModel: 'Add model',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelImageInputHint: '请只给真正能识图的模型打开。打开后可被自动识图选用。',
  addModel: '添加模型',
  removeModel: '删除模型',
