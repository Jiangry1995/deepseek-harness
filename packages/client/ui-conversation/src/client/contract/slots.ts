...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /** Optional renderer for durable images in the selected Tool result. */
...
export interface DetailsToolOwnerProps {
  ...
  cwd?: string | undefined
  /** Render Tool-result images through the attachment presentation slot. */
...
export interface DetailsInjected {
  ...
  closeDetails: () => void
  /** Resolve a session-authorized historical image for inline Tool-result display. */
  loadImage: (attachment: ImageAttachmentRef) => Promise<string>
}
