...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'browser_activate_tab', 'browser_click', 'browser_close_tab', 'browser_fill',
      'browser_focus', 'browser_inspect', 'browser_list_tabs', 'browser_open_tab',
      'browser_press', 'browser_read_page', 'browser_scroll', 'browser_select', 'browser_wait_for',
      ...
      'list_agents', 'list_agents', 'lsp', 'memory_list', 'memory_note', 'memory_read', 'memory_search',
      'pwsh', 'pwsh', 'ralph',
