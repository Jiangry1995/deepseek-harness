...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'Optional renderer for durable images in the selected Tool result.',
    doc: 'Optional renderer for durable images in the selected Tool result.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-web WebChip id \'web-networking\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-vision-fallback VisionFallbackSettingsTab id \'vision-fallback\'',
    ],
    replaceRisk: 'none',
