...
import { webProbeSearchRequestSchema } from '../api/web.schema.ts'
import {
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'web.probeSearch': { schema: webProbeSearchRequestSchema, invoke: (api, r, signal) => api.web.probeSearch(r, signal) },
}
